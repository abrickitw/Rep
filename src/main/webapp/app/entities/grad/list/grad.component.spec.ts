...
import { sampleWithRequiredData } from '../grad.test-samples';
import { GradService } from '../service/grad.service';

import { GradComponent } from './grad.component';
import SpyInstance = jest.SpyInstance;

describe('Grad Management Component', () => {
  let comp: GradComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(GradComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.grads?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to gradService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getGradIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getGradIdentifier).toHaveBeenCalledWith(entity);
