...
import { sampleWithRequiredData } from '../raspored.test-samples';
import { RasporedService } from '../service/raspored.service';

import { RasporedComponent } from './raspored.component';
import SpyInstance = jest.SpyInstance;

describe('Raspored Management Component', () => {
  let comp: RasporedComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(RasporedComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.rasporeds?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to rasporedService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getRasporedIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getRasporedIdentifier).toHaveBeenCalledWith(entity);
